...
var file_product_proto_rawDesc = []byte{
	...
	0x63, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x2f,
...
var file_product_proto_goTypes = []interface{}{
	(*ProductRequest)(nil),  // 0: domainservice.ProductRequest
	(*ProductResponse)(nil), // 1: domainservice.ProductResponse
}
var file_product_proto_depIdxs = []int32{
	0, // 0: domainservice.ProdService.GetProductStock:input_type -> domainservice.ProductRequest
	1, // 1: domainservice.ProdService.GetProductStock:output_type -> domainservice.ProductResponse
...
// ProdServiceClient is the client API for ProdService domainservice.
//
...
func (c *prodServiceClient) GetProductStock(ctx context.Context, in *ProductRequest, opts ...grpc.CallOption) (*ProductResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/domainservice.ProdService/GetProductStock", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// ProdServiceServer is the server API for ProdService domainservice.
...
func _ProdService_GetProductStock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/domainservice.ProdService/GetProductStock",
	}
...
var _ProdService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "domainservice.ProdService",
