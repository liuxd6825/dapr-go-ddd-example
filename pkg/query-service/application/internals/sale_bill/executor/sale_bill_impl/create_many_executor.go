...
// @Description: 新建多个
//
type saleBillCreateManyExecutor struct {
...
// @return error 错误
//
func (e *saleBillCreateManyExecutor) Execute(ctx context.Context, vList []*view.SaleBillView) error {
...
// @return error 错误
//
func (e *saleBillCreateManyExecutor) Validate(view []*view.SaleBillView) error {
	if view == nil {
...
//
func newSaleBillCreateManyExecutor() *saleBillCreateManyExecutor {
	return &saleBillCreateManyExecutor{
