...
// @Description: 更新多个
//
type saleBillUpdateExecutor struct {
...
// @return error 错误
//
func (e *saleBillUpdateExecutor) Execute(ctx context.Context, view *view.SaleBillView) error {
	if err := e.Validate(view); err != nil {
		return err
	}
	return session.StartSession(ctx, func(ctx context.Context) error {
		return e.saleBillService.Update(ctx, view)
	})
}
...
// @return error 错误
//
func (e *saleBillUpdateExecutor) Validate(view *view.SaleBillView) error {
	if view == nil {
...
//
func newSaleBillUpdateExecutor() *saleBillUpdateExecutor {
	return &saleBillUpdateExecutor{
