...
// @Description: 按Id查询
//
type saleBillFindByIdExecutor struct {
...
// @return error 错误
//
func (e *saleBillFindByIdExecutor) Execute(ctx context.Context, aq *appquery.SaleBillFindByIdAppQuery) (*view.SaleBillView, bool, error) {
	if err := e.Validate(aq); err != nil {
		return nil, false, err
	}

	return e.domainService.FindById(ctx, query.NewSaleBillFindByIdQuery(aq.TenantId, aq.Id))
}
...
// @return error 错误
//
func (e *saleBillFindByIdExecutor) Validate(aq *appquery.SaleBillFindByIdAppQuery) error {
	if aq == nil {
...
//
func newSaleBillFindByIdExecutor() *saleBillFindByIdExecutor {
	return &saleBillFindByIdExecutor{
