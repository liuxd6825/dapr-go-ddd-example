...
// @Description: 创建多个
//
type saleItemUpdateManyExecutor struct {
...
// @return error 错误
//
func (e *saleItemUpdateManyExecutor) Execute(ctx context.Context, vList []*view.SaleItemView) error {
...
// @return error 错误
//
func (e *saleItemUpdateManyExecutor) Validate(view []*view.SaleItemView) error {
	if view == nil {
...
//
func newSaleItemUpdateManyExecutor() *saleItemUpdateManyExecutor {
	return &saleItemUpdateManyExecutor{
