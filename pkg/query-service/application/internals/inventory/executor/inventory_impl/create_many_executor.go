...
// @Description: 新建多个
//
type inventoryCreateManyExecutor struct {
...
// @return error 错误
//
func (e *inventoryCreateManyExecutor) Execute(ctx context.Context, vList []*view.InventoryView) error {
...
// @return error 错误
//
func (e *inventoryCreateManyExecutor) Validate(view []*view.InventoryView) error {
	if view == nil {
...
//
func newInventoryCreateManyExecutor() *inventoryCreateManyExecutor {
	return &inventoryCreateManyExecutor{
