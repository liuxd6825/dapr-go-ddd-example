...
func (u *UserQueryService) Create(ctx context.Context, user *view.UserView) error {
	_, err := u.repos.CreateById(ctx, user)
	return err
}

func (u *UserQueryService) Update(ctx context.Context, user *view.UserView) error {
...
func (u *UserQueryService) FindById(ctx context.Context, tenantId, userId string) (*view.UserView, bool, error) {
	return u.repos.FindById(ctx, tenantId, userId)
}

func (u *UserQueryService) FindAll(ctx context.Context, tenantId string) (*[]*view.UserView, bool, error) {
	return u.repos.FindAll(ctx, tenantId)
}

func (u *UserQueryService) FindPaging(ctx context.Context, query ddd_repository.FindPagingQuery) (*ddd_repository.FindPagingResult[*view.UserView], bool, error) {
