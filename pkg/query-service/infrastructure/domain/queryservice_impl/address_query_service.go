...
func (u *AddressQueryService) FindPagingData(ctx context.Context, query ddd_repository.FindPagingQuery) (*ddd_repository.FindPagingResult[*projection.AddressView], bool, error) {
