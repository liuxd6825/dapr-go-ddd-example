...
// @Description: 更新销售订单
//
type SaleBillUpdateCommand struct {
	...
	Data        field.SaleBillUpdateFields `json:"data" validate:"-"`             // 业务数据
}
...
// @Description: 获取聚合根Id
//
func (c *SaleBillUpdateCommand) GetAggregateId() ddd.AggregateId {
...
// @Description: 获取命令Id
//
func (c *SaleBillUpdateCommand) GetCommandId() string {
	return c.CommandId
}
...
// @Description: 获取租户Id
//
func (c *SaleBillUpdateCommand) GetTenantId() string {
...
//
func (c *SaleBillUpdateCommand) GetIsValidOnly() bool {
...
// @Description: 命令数据验证
//
func (c *SaleBillUpdateCommand) Validate() error {
