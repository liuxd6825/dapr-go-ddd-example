...
require (
	...
	github.com/liuxd6825/dapr v1.12.0 // indirect
...
//replace github.com/liuxd6825/dapr-components-contrib => gitee.com/liuxd6825/components-contrib v1.7.1-1.0-alpha2
